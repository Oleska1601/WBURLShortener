...
4. В случае успешного обнаружения - статус `http.StatusMovedPermanently`
- во время выполнения этого запроса в отдельном процессе запускаем сохранение данных пользователя для последующей аналитики
